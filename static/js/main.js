...
districtSelection.onchange = (e) => {
  villageSelection.disabled = false;

  villageSelection.length = 1;
  for (let village of regionStateInfo[regionSelection.value][e.target.value]) {
    villageSelection.options[villageSelection.options.length] = new Option(
      village,
      village
    );
  }
